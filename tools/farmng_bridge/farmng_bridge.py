...
class FarmngBridge(Node):
    ...
    def publish_state(self, state):
        ...
        if state.HasField("motion_estimation"):
            ...
            # We currently publish only velocity information.
            # Position/orientation are intentionally not populated yet
            # because Farm-ng frame conventions have not been validated.
